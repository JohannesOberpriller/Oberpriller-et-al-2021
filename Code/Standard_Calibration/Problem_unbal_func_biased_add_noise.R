...
## sampler function to sample from the parameters priors 
...
## creating prior object for the MCMC sampler with BayesianTools 

prior <- createPrior(density = density, sampler = sampler,
                     lower = lower, upper = upper, best = best)

##Likelihood function used for the parameter inference 
...
LL <- function(pars){
  ...
  #prepare inital state variables 
...
## Function providing the negative log-likelihood for the optimizer 
...
save(out_MCMC, file = "./Results/MCMC_unbal_func_biased_add_noise.RData")
...
save(out_MCMC, file = "./Results/MCMC_unbal_func_biased_add_noise2.RData")
...
save(out_MCMC, file = "./Results/MCMC_unbal_func_biased_add_noise3.RData")
...
save(out_MCMC, file = "./Results/MCMC_unbal_func_biased_add_noise4.RData")
...
save(out_MCMC, file = "./Results/MCMC_unbal_func_biased_add_noise5.RData")
