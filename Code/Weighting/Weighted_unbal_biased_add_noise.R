...
#### Setting everything up for calibration ####
...
# density function to calculate density of priors
...
# sampler to sample parameters of the priors 

sampler <- function(n = 1){
  # flat priors for the model parameters
...
# set up prior for the use in the MCMC sampler of BAyesiaTOOLs 

prior <- createPrior(density = density, sampler = sampler,
                     lower = lower, upper = upper, best = best)

## Likelihood function to be used in the MCMC sampler 
...
LL <- function(pars){
  ...
  #prepare initial state-variables for basfor 
...
# function to handle the export of package to the cluster 
...
save(out_MCMC, file = "./Results/MCMC_unbal_biased_add_noise_weighted.RData")
...
save(out_MCMC, file = "./Results/MCMC_unbal_biased_add_noise_weighted2.RData")
...
save(out_MCMC, file = "./Results/MCMC_unbal_biased_add_noise_weighted3.RData")
...
save(out_MCMC, file = "./Results/MCMC_unbal_biased_add_noise_weighted4.RData")
...
save(out_MCMC, file = "./Results/MCMC_unbal_biased_add_noise_weighted5.RData")