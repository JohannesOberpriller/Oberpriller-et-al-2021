...
save(out, file = "./Results/MCMCchain_sampler_val.RData")
save(WAERR, file = "./Results/WA_sampler_val.RData")
save(RESPERR, file = "./Results/RESP_sampler_val.RData")
save(NPPERR, file = "./Results/NPP_sampler_val.RData")

save(predET, file = "./Results/PredET_sampler_val.RData")
save(predGPP, file = "./Results/PredGPP_sampler_val.RData")
